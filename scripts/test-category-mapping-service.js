...
async function testInitialization() {
  ...
  try {
    ...
    const serviceWithSpecialization = new CategoryMappingService(
      mockSpecializationService
    );
    logTest(
      'Service initializes with SpecializationService',
      serviceWithSpecialization !== null &&
        serviceWithSpecialization.specializationService !== null,
      '',
      'Initialization'
    );
    ...
    const isSorted =
      JSON.stringify(priorities) === JSON.stringify(sortedPriorities);
    logTest(
...
async function testMappingRules(categoryMappingService) {
  ...
  if (!categoryMappingService) {
    logTest(
      'Mapping Rules Tests',
      false,
      'CategoryMappingService not available',
      'Mapping Rules'
    );
    return;
  }
  ...
  try {
    ...
    const lowerResult =
      categoryMappingService.mapToThreeTierCategory(lowerCaseContent);
    logTest(
    ...
    const dataResult =
      categoryMappingService.mapToThreeTierCategory(dataContent);
    logTest(
    ...
    const programmingResult =
      categoryMappingService.mapToThreeTierCategory(programmingContent);
    logTest(
    ...
    logTest(
      ...
      dpaResult.appliedRule !== null &&
        dpaResult.appliedRule.priority !== undefined,
    ...
    logTest(
      ...
      dpaResult.categoryInfo !== null &&
        dpaResult.categoryInfo.name !== undefined,
...
async function testPriorityResolution(categoryMappingService) {
  ...
  try {
    ...
    const conflictResult =
      categoryMappingService.mapToThreeTierCategory(conflictContent);
    ...
    const explicitContent = {
      id: 'test-explicit',
      category: 'BP-AE-data-analysis',
    };
    const explicitResult =
      categoryMappingService.mapToThreeTierCategory(explicitContent);
    ...
    const unknownResult =
      categoryMappingService.mapToThreeTierCategory(unknownContent);
    ...
    const dpaExplicitContent = {
      id: 'test-dpa-explicit',
      category: 'BP-DPA-01',
    };
    const dpaKeywordContent = {
      id: 'test-dpa-keyword',
      category: 'etl-processes',
    };

    const dpaExplicitResult =
      categoryMappingService.mapToThreeTierCategory(dpaExplicitContent);
    const dpaKeywordResult =
      categoryMappingService.mapToThreeTierCategory(dpaKeywordContent);
    ...
    logTest(
      ...
      dpaExplicitResult.threeTierCategory === 'daten-prozessanalyse' &&
        ...
        dpaExplicitResult.appliedRule.priority >
          dpaKeywordResult.appliedRule.priority,
...
async function testEdgeCases(categoryMappingService) {
  ...
  try {
    ...
    logTest(
      ...
      nullResult.threeTierCategory === 'allgemein' &&
        nullResult.reason.includes('Error'),
    ...
    const undefinedResult =
      categoryMappingService.mapToThreeTierCategory(undefined);
    logTest(
      'Undefined content item handled gracefully',
      undefinedResult.threeTierCategory === 'allgemein' &&
        undefinedResult.reason.includes('Error'),
    ...
    const noCategoryResult =
      categoryMappingService.mapToThreeTierCategory(noCategoryContent);
    logTest(
    ...
    const emptyCategoryResult =
      categoryMappingService.mapToThreeTierCategory(emptyCategoryContent);
    logTest(
    ...
    const categoryIdContent = {
      id: 'test-category-id',
      categoryId: 'bp-dpa-01',
    };
    const categoryIdResult =
      categoryMappingService.mapToThreeTierCategory(categoryIdContent);
    logTest(
    ...
    const bothFieldsResult =
      categoryMappingService.mapToThreeTierCategory(bothFieldsContent);
    logTest(
    ...
    const longCategoryResult =
      categoryMappingService.mapToThreeTierCategory(longCategoryContent);
    logTest(
    ...
    const specialCharsResult =
      categoryMappingService.mapToThreeTierCategory(specialCharsContent);
    logTest(
    ...
    const unicodeResult =
      categoryMappingService.mapToThreeTierCategory(unicodeContent);
    logTest(
    ...
    logTest('Edge Cases Tests', false, `Error: ${error.message}`, 'Edge Cases');
  }
}
...
async function testValidationLogic(categoryMappingService) {
  ...
  try {
    ...
    const singleValidation =
      categoryMappingService.validateCategoryMapping(validContent);
    logTest(
      'Single valid item validation passes',
      singleValidation.status === 'success' &&
        singleValidation.validItems === 1,
    ...
    const arrayValidation =
      categoryMappingService.validateCategoryMapping(mixedContent);
    logTest(
      'Array validation handles mixed valid/invalid content',
      arrayValidation.totalItems === 5 &&
        arrayValidation.validItems === 4 &&
        arrayValidation.invalidItems === 1,
    ...
    logTest(
      ...
      Array.isArray(arrayValidation.details) &&
        arrayValidation.details.length === 5,
    ...
    const conflictContent = {
      id: 'conflict-test',
      category: 'bp-dpa-programming',
    };
    const conflictValidation =
      categoryMappingService.validateCategoryMapping(conflictContent);
    logTest(
    ...
    const relevanceValidation =
      categoryMappingService.validateCategoryMapping(relevanceContent);
    const hasRelevanceCheck =
      relevanceValidation.details[0].warnings.length >= 0;
    logTest(
    ...
    const validationConfig =
      categoryMappingService.getValidationConfiguration();
    logTest(
...
async function testSpecializationRelevance(categoryMappingService) {
  ...
  try {
    ...
    const dpaRelevance = categoryMappingService.getCategoryRelevance(
      'daten-prozessanalyse',
      'daten-prozessanalyse'
    );
    logTest(
    ...
    const aeRelevance = categoryMappingService.getCategoryRelevance(
      'anwendungsentwicklung',
      'anwendungsentwicklung'
    );
    logTest(
    ...
    const generalRelevance = categoryMappingService.getCategoryRelevance(
      'allgemein',
      'daten-prozessanalyse'
    );
    logTest(
    ...
    const crossRelevance = categoryMappingService.getCategoryRelevance(
      'daten-prozessanalyse',
      'anwendungsentwicklung'
    );
    logTest(
    ...
    const invalidRelevance = categoryMappingService.getCategoryRelevance(
      'invalid-category',
    ...
    const nullRelevance = categoryMappingService.getCategoryRelevance(
      null,
      null
    );
    logTest(
    ...
    const serviceWithMockSpecialization = new (
      await import('../src/services/CategoryMappingService.js')
    ).default(mockSpecializationService);
    const specializationContent = {
      id: 'test-specialization',
      category: 'test-high-dpa',
    };
    const specializationResult =
      serviceWithMockSpecialization.mapToThreeTierCategory(
...
async function testPerformance(categoryMappingService) {
  ...
  try {
    ...
    const rulesValidationTime =
      rulesValidationEndTime - rulesValidationStartTime;
...
function generateTestReport() {
  ...
  if (testResults.failed === 0) {
    console.log(
      '   ✅ All tests passed! CategoryMappingService is working correctly.'
    );
...
async function runAllTests() {
  ...
  console.log(
    '║         CategoryMappingService Unit Tests                    ║'
  );
  console.log(
    '║         Requirements: 1.1, 1.2                              ║'
  );
...
if (
  ...
  import.meta.url.endsWith('test-category-mapping-service.js')
) {
