    ...
    questions: [
      {
        ...
        explanation:
          'Der Abschnitt vermittelt ein zentrales Teilthema des Moduls.',
        points: 1,
      },
      {
        id: 'q2',
        ...
        correctAnswer: true,
        explanation:
          'Die Gliederung der H2 Abschnitte bildet die Modulstruktur ab.',
        points: 1,
      },
      {
        id: 'q3',
        ...
        explanation:
          'Abschnitte adressieren relevante Lerninhalte und unterstützen Prüfungsvorbereitung.',
        points: 1,
      },
    ],
  };
...
function main() {
  ...
  console.log(
    `Integration complete. Modules modified: ${modifiedCount}/${files.length}`
  );
}
